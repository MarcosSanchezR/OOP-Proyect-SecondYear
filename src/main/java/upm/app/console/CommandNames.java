...
public enum CommandNames {
    ...
    CREATE_MATCH("create-match", ". Se crea un partido", Rol.autorized(), "<dd-MM-yyyy HH-mm-ss>", "<dni-jugador1>", "<dni-jugador2>", "<nombre-pista>"),
    ESTABLISH_WINNER("establish-winner", ". Establece un ganador al partido", Rol.autorized(), "<dd-MM-yyyy HH-mm-ss> (inicio)", "<nombre-pista>", "<dni-ganador>"),
