...
public class TennisSeeder {
    ...
    public void seed() {
        ...
        Match[] matches = {
                new Match(LocalDateTime.of(3000, 11, 1, 12, 30, 0), users[0], users[1], courts[0]),
                new Match(LocalDateTime.of(3000, 11, 2, 12, 30, 0), users[2], users[1], courts[2]),
                new Match(LocalDateTime.of(3000, 11, 3, 12, 30, 0), users[2], users[3], courts[1]),
                new Match(LocalDateTime.of(3000, 11, 4, 12, 30, 0), users[0], users[3], courts[3])
